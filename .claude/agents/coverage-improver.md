...
1. Run `uv run pytest --cov jxa_lib --cov-branch --cov-report term-missing:skip-covered`
...
4. Run `uv run pytest --cov jxa_lib --cov-branch --cov-report term-missing:skip-covered`
