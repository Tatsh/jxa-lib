...
Prepare and publish a new release for the jxa-lib project.
...
1. **Run the test suite.** Run `yarn test`. Every test must pass.
...
1. **Update GitHub release notes** using `gh` (authenticated for this repository). After the tag
   ...
   - **Full Changelog line:** After the body, append **one blank line**, then exactly:
     `**Full Changelog**: https://github.com/Tatsh/jxa-lib/compare/vPREV...vNEW`
