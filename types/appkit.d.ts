...
interface NSPasteboard extends BridgedObject<IdType> {
    ...
    static pasteboardByFilteringDataOfType(data: NSData, ofType: NSPasteboardType): NSPasteboard;
    static pasteboardByFilteringFile(filename: JXString): NSPasteboard;
    static pasteboardByFilteringTypesInPasteboard(pasteboard: NSPasteboard): NSPasteboard;
